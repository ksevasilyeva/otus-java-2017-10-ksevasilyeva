...
public class AtmControllerTest {
    ...
    public void testGetMinMoneyTokens() {
        ...
        int[] minTokensArray = AtmController.getMinMoneyTokens(tokenCells,9);
    ...
    public void tesMinTokensExpectOneToken() {
        ...
        int[] minTokensArray = AtmController.getMinMoneyTokens(tokenCells,10);
    ...
    public void testWithdrawCash() {
        ...
        boolean operationResult = AtmController.withdrawCash(tokenCells, 6);
    ...
    public void shouldNotWithdrawZero() {
        ...
        boolean operationResult = AtmController.withdrawCash(tokenCells, 0);
    ...
    public void shouldPutInMoneyTokenCell() {
        ...
        boolean operationResult = AtmController.putInMoneyTokenCell(tokenCells, 10);

        assertThat(operationResult, is(true));
        assertThat(AtmController.getTokenCellByValue(tokenCells, 10).get().getBalance(), is(10));
        assertThat(AtmController.getTokenCellByValue(tokenCells, 1).get().getBalance(), is(0));
        assertThat(AtmController.getTokenCellByValue(tokenCells, 100).get().getBalance(), is(0));
    }
}
